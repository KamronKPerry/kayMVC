...
namespace KayMVC.UI.Controllers
{
    public class AchievementsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AchievementID,Name,Hightlight")] Achievement achievement)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AchievementID,Name,Hightlight")] Achievement achievement)
        {
            if (ModelState.IsValid)
            {
