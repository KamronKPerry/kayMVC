...
namespace KayMVC.UI.Controllers
{
    public class InstitutionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "InsitutionID,InstitutionName,InstitutionCity,InstitutionState")] Institution institution)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "InsitutionID,InstitutionName,InstitutionCity,InstitutionState")] Institution institution)
        {
            if (ModelState.IsValid)
            {
